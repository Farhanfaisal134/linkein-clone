...
const Sidebar = async ({ user }: { user: any }) => {
  ...
  return (
    <div className='hidden md:block w-[20%] h-fit border bordergray-300 bg-white rounded-lg sticky top-14'>
      <div className='flex relative flex-col items-center'>
        ...
        <div className='border-b border-b-gray-300'>
          <div className='p-2 mt-5 text-center'>
            <h1 className='font-bold hover:underline cursor-pointer'>{user ? `${user?.firstName}` : "Farhan"}</h1>
